...
const generateToRoot = () => {
  ...
  fs.writeFile('./static/index.css', `${styleSheet.replace(RegExp.tabAndLine, '').replace(RegExp.doubleWhitespace, '')}`, () => {})
}
